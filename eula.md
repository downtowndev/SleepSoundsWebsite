Sleep Sounds is licensed to You (End-User) by Andrew Sverdrup ("Licensor"), for use only under the terms of this License Agreement.
...
Sleep Sounds when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. Sleep Sounds is to be used on devices that operate with Apple's operating systems ("iOS" and "Mac OS") or Google's operating system ("Android").
...
Sleep Sounds ("Licensed Application") is a piece of software created to provide audio of white noises and nature sounds — and customized for iOS and Android mobile devices ("Devices"). It is used to provide ambient noise .
...
3.1  The Licensed Application requires a firmware version iOS 12.4 or Android OS 11 or higher. Licensor recommends using the latest version of the firmware.
...
You acknowledge that Licensor will be able to access and adjust Your downloaded Licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy: https://downtowndev.github.io/SleepSoundsWebsite/privacy.
...
9.3  You are required to inspect the Licensed Application immediately after installing it and notify Andrew Sverdrup about issues discovered without delay by email provided in Contact Information. The defect report will be taken into consideration and further investigated if it has been emailed within a period of days after discovery.
